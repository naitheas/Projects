...
// prints root node, left in order of occurence, mids, right in order of occurence
  dfsPreOrder() {
    let data = [];
    let current = this.root;
   ...
   * Return an array of visited nodes. */
// prints full left branch,root node, right branch
  dfsInOrder() {
    let data = [];
    let current = this.root;
   ...
   * Return an array of visited nodes. */
//prints left leaf nodes,left parent node, right leaf nodes, right parent node, root node
  dfsPostOrder() {
    let data = [];
    let current = this.root;
